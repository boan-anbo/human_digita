...
class Idea(TimeStampedModel, ActivatorModel, models.Model):
    id=models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    # in the form of STATEMENT: A is B or JUDGMENT: A should BE B
    name = models.CharField(max_length=255)
    gist = models.CharField(max_length=256, blank=True, default='')
    ...
    projects = ManyToManyField(Project, related_name='ideas', blank=True)
