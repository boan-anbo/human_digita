...
MIGRATION_MODULES = {"sites": "human_digita.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "human_digita.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Bo An""", "bo-an@example.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "human_digita.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "human_digita.users.adapters.SocialAccountAdapter"
# django-compressor
# ------------------------------------------------------------------------------
